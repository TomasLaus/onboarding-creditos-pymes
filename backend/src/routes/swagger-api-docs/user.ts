                                        ...
                                        error: {
                                            ...
                                            properties: {
                                                ...
                                                meta: {
                                                    type: 'object',
                                                    properties: {
                                                        modelName: { type: 'string', example: 'User' },
                                                        target: { type: 'array', items: { type: 'string', example: 'email' } },
                                                    },
                                                },
                                                clientVersion: { type: 'string', example: '6.16.3' },
                                                name: { type: 'string', example: 'PrismaClientKnownRequestError' },
                                            },
                                        },
                                    },
                                },
