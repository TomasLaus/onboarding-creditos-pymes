...
const CreditForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.tipoDocumento) newErrors.tipoDocumento = 'Seleccione tipo de documento';
    if (!formData.numDocumento) newErrors.numDocumento = 'Ingrese número de documento';
    ...
    if (!formData.aceptaDatos) newErrors.aceptaDatos = 'Debe aceptar el tratamiento de datos';
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/API/TU_ENDPOINT_DE_GUARDADO', formData);
      ...
      if (error.response) {
        setServerError(`Error del servidor: ${error.response.data.message || error.message}`);
  ...
  const handleContinue = () => {
    navigate('/dashboard/documentos-dos');
  };
  ...
  return (
    <div className="form-container">
      ...
      {serverError && <div className="form-error-general" style={{color: 'red', marginBottom: '15px', textAlign: 'center'}}>{serverError}</div>}
      ...
      <form>
        ...
        <div className="form-group">
          ...
          {errors.producto && <small className="form-error-field" style={{color: 'red'}}>{errors.producto}</small>}
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          {errors.idFiscal && <small className="form-error-field" style={{color: 'red'}}>{errors.idFiscal}</small>}
        </div>

        <div className="form-group">
          <label htmlFor="moneda">Elije moneda</label>
          <select id="moneda" name="moneda" value={formData.moneda} onChange={handleChange} required>
            <option value="">Seleccionar moneda</option>
            <option value="dolares">Dólares</option>
            <option value="peso">Peso</option>
          </select>
          {errors.moneda && <small className="form-error-field" style={{color: 'red'}}>{errors.moneda}</small>}
        </div>

        <div className="form-group">
          <label htmlFor="ventas">Ventas promedio mensuales</label>
          <select id="ventas" name="ventas" value={formData.ventas} onChange={handleChange} required>
          ...
          {errors.ventas && <small className="form-error-field" style={{color: 'red'}}>{errors.ventas}</small>}
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          {errors.monto && <small className="form-error-field" style={{color: 'red'}}>{errors.monto}</small>}
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          <small className="form-helper-text">Min. 1 mes - Max. 120 meses</small>
          {errors.plazo && <small className="form-error-field" style={{color: 'red', display: 'block'}}>{errors.plazo}</small>}
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <select id="tipoDocumento" name="tipoDocumento" value={formData.tipoDocumento} onChange={handleChange} required>
              ...
              <option value="permisoTemporal">Permiso Temporal de Permanencia</option>
            </select>
            {errors.tipoDocumento && <small className="form-error-field" style={{color: 'red'}}>{errors.tipoDocumento}</small>}
          </div>
          <div className="form-group">
            ...
            <input
              ...
              required
            />
            {errors.numDocumento && <small className="form-error-field" style={{color: 'red'}}>{errors.numDocumento}</small>}
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          {errors.nombre && <small className="form-error-field" style={{color: 'red'}}>{errors.nombre}</small>}
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          {errors.celular && <small className="form-error-field" style={{color: 'red'}}>{errors.celular}</small>}
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          {errors.email && <small className="form-error-field" style={{color: 'red'}}>{errors.email}</small>}
        </div>
        ...
        <div className="form-group-checkbox">
          <input
            ...
            required
          />
          <label htmlFor="aceptaDatos">He leído y acepto el Tratamiento de datos personales</label>
          {errors.aceptaDatos && <small className="form-error-field" style={{color: 'red', display: 'block'}}>{errors.aceptaDatos}</small>}
        </div>
        ...
        <div className="form-group-checkbox">
          ...
          {errors.aceptaTerminos && <small className="form-error-field" style={{color: 'red', display: 'block'}}>{errors.aceptaTerminos}</small>}
        </div>
